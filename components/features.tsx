      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Your workflow will never be interupted again</h2>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Seamless Note-Taking</h4>
              <p className="text-lg text-gray-400 text-center">Effortlessly open floating notes with a simple shortcut, Ctrl + L, and immediately start jotting down your thoughts without disrupting your workflow.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Elevate Your Note-Taking</h4>
              <p className="text-lg text-gray-400 text-center">Enhance your productivity and creativity with Flowplane's innovative text editor, seamlessly integrated into the app's functionality.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Rust-Powered Efficiency</h4>
              <p className="text-lg text-gray-400 text-center">Built with Rust, Flowplane ensures top-notch performance and reliability. </p>
            </div>
